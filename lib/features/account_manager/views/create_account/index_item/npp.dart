...
class CreateNPP extends StatefulWidget {
  CreateNPP({required this.controller, super.key});

  CreateUserController controller;
  @override
  State<CreateNPP> createState() => _CreateNPPState();
}

class _CreateNPPState extends State<CreateNPP> {
      ...
      SizedBox(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              Text(
                'Thông tin người đại diện nhà phân phối',
